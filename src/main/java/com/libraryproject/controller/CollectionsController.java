...
import com.libraryproject.dto.CollectionsDTO;
...
public class CollectionsController {
    ...
    @PostMapping
	public void register(@RequestBody CollectionsDTO collectionsDto) {
		Collections collections = modelMapper.map(collectionsDto, Collections.class);
